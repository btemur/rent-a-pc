...
{
    class DataManagementJsonPrototype : IDataManagement
    {
        private static DataManagementJsonPrototype dataManagementSQL;
        protected string connString = "server=localhost;port=3306;database=rent_a_pc2;uid=root;pwd=";
        private DataManagementJsonPrototype()
        {

        }
        public static DataManagementJsonPrototype GetInstance()
        {
            if (dataManagementSQL == null)
            {
                dataManagementSQL = new DataManagementJsonPrototype();
            }
